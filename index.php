        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <!-- search bar------------------------------------- -->
            <div class="mb-6 flex items-center justify-between">
              ...
              <a href="./index.php?all_courses" class="text-gray-600 bg-gray-50 hover:text-red-600 hover:bg-red-50 whitespace-nowrap px-3 py-1 rounded-full"> All Courses</a>
  ...
  <!---------------------------------------------- Courses Section -------------------------------------------------> 
    ...
    <?php elseif(isset($_GET['category_name'])): ?>
      ...
      <?php if ($coursesByCategory): ?>
              <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <?php foreach($coursesByCategory AS $course): ?>
                  <div class="bg-white rounded-lg overflow-hidden shadow-sm border hover:shadow-md transition-shadow">
                      <div class="relative">
                          <img src="<?php echo $course['image']; ?>" alt="" class="w-full h-48 object-cover">
                      </div>
    ...
    <?php elseif(isset($_GET['search'])): ?>
        <div class="mb-8">
            ...
            <?php if ($searchedValue): ?>
              <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <?php foreach($searchedValue AS $course): ?>
                  <div class="bg-white rounded-lg overflow-hidden shadow-sm border hover:shadow-md transition-shadow">
                      <div class="relative">
                          <img src="<?php echo $course['image']; ?>" alt="" class="w-full h-48 object-cover">
                      </div>
